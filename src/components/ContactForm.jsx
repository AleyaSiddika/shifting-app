...
const ContactForm = ({ onSubmit }) => {
  ...
  return (
    <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
      <h1 className="text-4xl mx-auto md:text-5xl lg:text-7xl text-nowrap font-bold tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-primary-700 via-purple-600 to-blue-400">
        Let’s Talk
      </h1>
